...
//    делаем winner волатил , чтобы только первый обратившийся успел его изметить
    public static volatile boolean winner = true;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cars.length; i++) {
            cars[i] = new Car(
                    race, 20
                    + (int) (Math.random() * 10),
                    countDownLatchReady, countDownLatchOver);
        }
